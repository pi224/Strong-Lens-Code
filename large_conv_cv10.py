...
SAVE_FILE = '../results/blurdec_largeconvnet_indexes.pkl'
...
print(X_FILE, Y_FILE, SAVE_FILE, IMAGE_AUGMENTATION)
# ---------------------------------------

model_function = models_preprocessing.compiledLargeConvnet
num_epochs = 1 #12
